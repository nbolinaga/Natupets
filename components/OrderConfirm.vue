    ...
    >
      ...
      >
        ...
        <p class="text-left text-sm mt-2">
          Nos pondremos en contacto con usted cuando su pedido este listo para
          hacer pickup
        </p>
      </div>
      <div
      ...
      >
        ...
        <p class="text-xs">{{ user.direccion }}</p>
        <p class="text-left text-sm mt-2">
          Nos pondremos en contacto con usted cuando su pedido este listo para
          ser enviado a su dirección
        </p>
      </div>
    </div>
    <p class="text-justify text-last-center mt-4">
      Si alguna de la información proporcionada es incorrecta ingrese a su
      perfil y haga click en cancelar pedido, corrija la información y vuelva a
      intentar
    </p>
  </div>
</template>
