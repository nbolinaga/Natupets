<template>
  <div class="mb-6 text-center">
    <div v-if="edit">
        ...
        <p v-if="enviado" class="text-sm mt-2">Código enviado, espere unos minutos antes de intentar de nuevo. Para intentar de nuevo haga click en Cancelar</p>
    </div>
	...
	methods: {
        makeid() {
            if (this.numberRaw.length !== 10) {
                alert("El número debe tener 10 dígitos sin espacios\nRecuerde colocar el código sin 0\nEjemplo: 4141234567");
                return;
            }
