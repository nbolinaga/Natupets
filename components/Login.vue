<template>
	<div class="w-screen overflow-hidden">
		...
		<p class="text-2xl text-justify md:px-[25vw] px-[8vw] my-8 text-last-center">
		...
		<div class="hidden md:block">
			...
			<p class="text-sm w-screen text-justify px-[8vw] text-last-center mb-8">
				No recolectamos ninguna información de tu correo electrónico, simplemente
				usamos gmail para facilitar el manejo de ingreso de nuestros clientes
			</p>
		</div>
		<img
			src="../static/dog.jpg"
